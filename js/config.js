...
const UPCOMING_PROGRAMS = [
  {
    ...
    tagHi: '✦ सोनीपत · 3-दिवसीय कार्यक्रम',
    title: 'Diabetes Management Program',
    titleHi: 'डायबिटीज मैनेजमेंट प्रोग्राम',
    image: 'assets/images/hero-bg.webp',
    cardDesc: 'A 3-day guided program combining Classical Hatha Yoga, Ayurvedic & Siddha medical consultation, and practical diet guidance — manage diabetes naturally.',
    cardDescHi: 'क्लासिकल हठ योग, आयुर्वेदिक और सिद्ध चिकित्सा परामर्श, और व्यावहारिक आहार मार्गदर्शन को संयोजित करने वाला 3-दिवसीय निर्देशित कार्यक्रम — प्राकृतिक रूप से डायबिटीज को प्रबंधित करें।',
    pageDesc: 'Diabetes ko manage karein Naturally!\n\nA 3-day guided program combining Classical Hatha Yoga, Ayurvedic & Siddha medical consultation, and practical diet guidance — taught right here in Sonepat, in the classical tradition transmitted through Sadhguru Gurukulam.',
    pageDescHi: 'डायबिटीज को प्राकृतिक रूप से प्रबंधित करें!\n\nक्लासिकल हठ योग, आयुर्वेदिक और सिद्ध चिकित्सा परामर्श, और व्यावहारिक आहार मार्गदर्शन को संयोजित करने वाला 3-दिवसीय निर्देशित कार्यक्रम।',
    subtitle: 'Oct 2–4, 2026 | Sector-15, Sonepat',
    subtitleHi: '2–4 अक्टूबर, 2026 | सेक्टर-15, सोनीपत',
    benefits: [
      'Classical Hatha Yoga practices for metabolic health',
      'One-on-one Online Ayurvedic & Siddha Doctor Consultation',
      'Personalized Diet & Lifestyle Plan',
      'Monthly follow-ups with doctors and regular yoga teacher guidance',
    ],
    benefitsHi: [
      'मेटाबोलिक स्वास्थ्य के लिए क्लासिकल हठ योग अभ्यास',
      'आयुर्वेदिक और सिद्ध डॉक्टर के साथ एक-पर-एक ऑनलाइन परामर्श',
      'व्यक्तिगत आहार और जीवन शैली योजना',
      'डॉक्टरों और हठ योग शिक्षक के साथ नियमित फॉलो-अप',
    ],
    date: '2–4 October 2026',
    time: '10:00 AM – 1:00 PM',
    location: 'Sector-15, Sonepat',
    link: 'programs/diabetes-management.html',
  ...
  },
  {
    ...
    tag: '✦ Sonepat · Review Session · ₹1,000',
    tagHi: '✦ सोनीपत · रिव्यू सत्र · ₹1,000',
    title: 'Asanas Review',
    titleHi: 'आसन रिव्यू',
    image: 'assets/images/practice-yogasanas.webp',
    cardDesc: 'A dedicated review and practice refinement session for those who have already learned Yogasanas. Refine your postures, correct alignments, and deepen your practice.',
    cardDescHi: 'योगासन सीख चुके अभ्यासियों के लिए एक समर्पित रिव्यू और सुधार सत्र। अपने आसनों को शुद्ध करें, संरेखण ठीक करें और अभ्यास को गहरा करें।',
    pageDesc: 'A dedicated review and refinement session for those who have already learned Yogasanas.\n\n🌿 Conducted by a Sadhguru Gurukulam Certified Classical Hatha Yoga Teacher\n\n📅 13 Sep (Sun): 11:00 AM – 1:00 PM\n📍 Dhyana Yogasthala, 812, Sector-15, Sonepat\n\nDeepen your alignment, refine subtle aspects of each posture, clarify doubts, and ensure your daily practice is accurate and effective.\n\n⚠️ Pre-requisite: Open only to those who have already learned Yogasanas.',
    pageDescHi: 'योगासन सीख चुके अभ्यासियों के लिए एक समर्पित रिव्यू और सुधार सत्र।\n\n🌿 सद्गुरु गुरुकुलम प्रमाणित क्लासिकल हठ योग शिक्षक द्वारा संचालित\n\n📅 13 सितंबर (रवि): सुबह 11:00 – दोपहर 1:00 बजे\n📍 ध्यान योगस्थल, 812, सेक्टर-15, सोनीपत\n\nअपने आसनों के संरेखण को गहरा करें, प्रत्येक मुद्रा के सूक्ष्म पहलुओं को शुद्ध करें, शंकाओं का समाधान करें और अभ्यास को प्रभावी बनाएं।\n\n⚠️ पूर्व-आवश्यकता: केवल उन लोगों के लिए जिन्होंने पहले योगासन सीखा है।',
    subtitle: '13 Sep | Dhyana Yogasthala, Sonepat | ₹1,000',
    subtitleHi: '13 सितंबर | ध्यान योगस्थल, सोनीपत | ₹1,000',
    benefits: [
      'Posture corrections and subtle alignment checks',
      'Refine breath coordination and depth in asanas',
      'Clarify questions regarding daily practice',
      'Re-energize and deepen your Yogasanas practice',
    ],
    benefitsHi: [
      'आसन सुधार और सूक्ष्म संरेखण जांच',
      'आसनों में श्वास समन्वय और गहराई को परिष्कृत करना',
      'दैनिक अभ्यास से संबंधित प्रश्नों का समाधान',
      'योगासन अभ्यास को पुनः ऊर्जावान और गहरा बनाना',
    ],
    date: '13 September 2026 (Sun)',
  ...
  },
  {
    ...
    cardDesc: 'Traditionally available only to select groups of yogis, Surya Kriya is a potent 21-step yogic practice designed as a complete spiritual process.',
    cardDescHi: 'परंपरागत रूप से केवल चुनिंदा योगियों के समूहों के लिए उपलब्ध, सूर्य क्रिया 21 चरणों का एक शक्तिशाली योगिक अभ्यास है जो एक पूर्ण आध्यात्मिक प्रक्रिया है।',
    pageDesc: 'Move. Breathe. Meditate. Transform.\n\n"An asana is a dynamic form of meditating" — Sadhguru\n\nSurya Kriya is a potent 21-step yogic practice of tremendous antiquity, designed as a holistic process for health, wellness, and complete inner wellbeing.\n\n📅 18–20 Sep 2026 (Fri–Sun): 11:00 AM – 1:00 PM\n📍 Dhyana Yogasthala, 812, Sector-15, Sonepat\n\nPre-registration is mandatory and the program is suited for beginners (Age 14+).',
    pageDescHi: 'चलें। साँस लें। ध्यान करें। रूपांतरित हों।\n\n"एक आसन ध्यान का एक गतिशील रूप है" — सद्गुरु\n\nसूर्य क्रिया अत्यधिक प्राचीन काल का एक शक्तिशाली 21-चरणीय योगिक अभ्यास है, जिसे स्वास्थ्य, कल्याण और पूर्ण आंतरिक कल्याण के लिए डिज़ाइन किया गया है।\n\n📅 18–20 सितंबर 2026 (शुक्र–रवि): सुबह 11:00 – दोपहर 1:00 बजे\n📍 ध्यान योगस्थल, 812, सेक्टर-15, सोनीपत\n\nपूर्व-पंजीकरण अनिवार्य है और यह कार्यक्रम शुरुआती लोगों के लिए उपयुक्त है (आयु 14+)।',
    subtitle: '18–20 Sep | Dhyana Yogasthala, Sonepat | ₹3,500',
    subtitleHi: '18–20 सितंबर | ध्यान योगस्थल, सोनीपत | ₹3,500',
    benefits: [
      'Develop mental clarity, focus & concentration',
      'Relieve chronic back & cervical pain',
      'Boost energy levels and balance hormonal system',
      'Prepare the system for deeper meditative states',
    ],
    benefitsHi: [
      'मानसिक स्पष्टता, एकाग्रता और ध्यान में सुधार',
      'पीठ और सर्वाइकल के पुराने दर्द से राहत',
      'ऊर्जा स्तर में वृद्धि और हार्मोनल संतुलन',
      'गहरी ध्यान अवस्थाओं के लिए शरीर को तैयार करना',
    ],
    date: '18–20 September 2026 (Fri–Sun)',
    time: '11:00 AM – 1:00 PM',
    location: 'Dhyana Yogasthala, 812, Sector-15, Sonepat',
    price: '₹3,500',
