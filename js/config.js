...
const UPCOMING_PROGRAMS = [
  ...
  },
  {
    ...
    cardDesc: 'Experience Yogasanas in their classical form — a powerful practice to bring stability, balance and a deeper sense of wellbeing to the body and mind.',
    ...
    benefitsHi: [
      'शारीरिक स्वास्थ्य और लचीलेपन में सुधार',
      'मानसिक स्पष्टता और भावनात्मक संतुलन',
      'आंतरिक स्थिरता और सहजता',
      'गहरे ध्यान के लिए शरीर को तैयार करना',
    ],
    date: '15–16 August (Sat–Sun)',
    time: '11:00 AM–1:30 PM & 6:00–8:30 PM',
    location: 'Adiyog Yogashala, Nirthan Village, Sonepat',
